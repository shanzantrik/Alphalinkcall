  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-[#f5faff] to-[#eaf4fb] w-full max-w-7xl mx-auto py-16 px-4">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="relative w-[340px] h-[400px] flex flex-col gap-4" id="outer">
            ...
            <div className="relative w-full h-1/2 overflow-hidden shadow-lg rounded-t-[20px] rounded-br-[60px] border-4 border-[#f48e1b] animate-gold-glow">
              <Image src="/about2.webp" alt="Australia" fill className="object-cover w-full h-full" style={{ borderTopLeftRadius: 20, borderTopRightRadius: 20, borderBottomRightRadius: 60, borderBottomLeftRadius: 0 }} loading="lazy" fetchPriority="low" />
            </div>
            {/* Bottom Image Pane */}
            <div className="relative w-full h-1/2 overflow-hidden shadow-lg rounded-b-[20px] rounded-tl-[60px] border-4 border-[#f48e1b] animate-gold-glow">
              <Image src="/about1.webp" alt="Teamwork" fill className="object-cover w-full h-full" style={{ borderBottomLeftRadius: 20, borderBottomRightRadius: 20, borderTopLeftRadius: 60, borderTopRightRadius: 0 }} loading="lazy" fetchPriority="low" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mb-24 flex flex-col md:flex-row gap-16 items-center">
        <Image src="/story.webp" alt="Our Story" width={670} height={400} className="rounded-2xl shadow-2xl w-full max-w-xl object-cover flex-1" loading="lazy" fetchPriority="low" />
