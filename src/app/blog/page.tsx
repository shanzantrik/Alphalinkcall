  ...
  return (
    <div className="w-full max-w-7xl mx-auto py-16 px-4">
      ...
      <div className="text-center mt-10">
        <Link href="/contact" className="inline-block px-8 py-4 bg-gradient-to-r from-gray-800 to-gray-600 text-white rounded-full font-semibold text-lg shadow hover:from-gray-900 hover:to-gray-700 transition">Contact Us for a Consultation</Link>
      </div>
    </div>
  );
}
